...
public class StringCodeTest extends TestCase {
	...
	public void testStringIntersect1() {
	    ...
	    assertTrue(StringCode.stringIntersect("abcd", "abcde", 2));
	    assertTrue(StringCode.stringIntersect("abcd", "abcde", 4));
	    assertTrue(StringCode.stringIntersect("aaaaaab", "aaaaaaa", 3));
	}
	
	public void testStringIntersect2() {
	    assertFalse(StringCode.stringIntersect("a", "a", 2));
	    assertFalse(StringCode.stringIntersect("a", "b", 1));
	}
	
	public void testStringIntersect3() {
	    assertTrue(StringCode.stringIntersect("abc", "cadjjfaiopekanbnkjaifbcopeafkjd", 2));
	}
}
