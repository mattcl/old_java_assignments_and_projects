...
public class MovSim {
    ...
    public MovSimStat[] futurePos(int steps, Point2D.Double location, double velocity, double maxVel, double heading, double distanceRemaining, double turnRemaining, double bfWidth, double bfHeight) {
    ...
    public MovSimStat[] futurePos(int steps, double x, double y, 
